 ...
 */
function makePersistent(bindable, uniqueKey, customStore) {
    return __awaiter(this, void 0, void 0, function () {
        function subscribeToBindable() {
            // Save newly received data to localForage.
            bindable.subscribe(function (value) {
                store.setItem(uniqueKey, value);
            });
        }
        var store, savedValue, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    store = customStore || localforage_1.default;
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, store.getItem(uniqueKey)];
                case 2:
                    savedValue = _a.sent();
                ...
                case 3:
                    ...
                    subscribeToBindable();
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/, bindable];
            }
        });
    });
}
exports.makePersistent = makePersistent;
